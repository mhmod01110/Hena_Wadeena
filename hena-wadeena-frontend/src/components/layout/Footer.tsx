        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/logistics" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <li>
                <Link to="/investment" className="text-muted-foreground hover:text-primary transition-colors">
                  {t("footer.links.investment")}
                </Link>
              </li>
              <li>
                <Link to="/tourism" className="text-muted-foreground hover:text-primary transition-colors">
                  {t("footer.links.tourism")}
                </Link>
              </li>
            </ul>
          </div>
